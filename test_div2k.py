...
if __name__ == "__main__":
    ...
    print(f'INFERENCE ON {opt.set}, bright {opt.bright}, noise {opt.noise}')
    ...
    try:
        ...
        if opt.ares:
            in_root = f'/media/data4b/cindy/custom_DIV2k_{opt.set}/input/v{opt.bright}_n{opt.noise}'
            out_root = f'/media/data4b/cindy/custom_DIV2k_{opt.set}/ldm/v{opt.bright}_n{opt.noise}'
        else:
            in_root = f'/home/cindy/PycharmProjects/data/custom_DIV2k_{opt.set}/input/v{opt.bright}_n{opt.noise}'
            out_root = f'/home/cindy/PycharmProjects/data/custom_DIV2k_{opt.set}/ldm/v{opt.bright}_n{opt.noise}'
